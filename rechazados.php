...
<body>
	...
	<div class="container">
			    ...
			    <ul class="nav navbar-nav">
			      ...
			      <li class="dropdown">
			        ...
			        <ul class="dropdown-menu">
			          <li><a href="aprobados.php">Aprobados</a></li>
			          <li><a href="poraprobar.php">Por Aprobar</a></li>
			          <li class="active"><a href="rechazados.php">Rechazados</a></li>
			        </ul>
			      </li>
			    </ul>
			  </div><!--/.nav-collapse -->
	    ...
	    <div class="jumbotron">
			...
			<!-- Tabla Ppal -->
			<legend>Pagos Rechazados</legend>
						...
						<table class="table demo table-bordered" data-filter="#filter" data-page-size="5" data-page-previous-text="prev" data-page-next-text="next">
							...
							<tbody>
							  	...
							  	<?php
						            ...
						            $query = "SELECT * FROM Pagos WHERE Aprobado = 2";
